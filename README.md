...
### Maven users ([Java SDK Maven Repo Reference](https://mvnrepository.com/artifact/com.precisely.apis/PreciselyAPISJavaSDK))
...
```groovy
 implementation "com.precisely.apis:PreciselyAPISJavaSDK:12.0.3"
```
...
* target/PreciselyAPISJavaSDK-12.0.3.jar
* target/lib/*.jar
