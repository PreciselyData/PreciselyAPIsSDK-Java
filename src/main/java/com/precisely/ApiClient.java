...
import com.precisely.auth.Authentication;
import com.precisely.auth.HttpBasicAuth;
import com.precisely.auth.HttpBearerAuth;
import com.precisely.auth.ApiKeyAuth;
import com.precisely.auth.OAuth;
import com.precisely.auth.RetryingOAuth;
import com.precisely.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://api.precisely.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/11.9.3.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.precisely.com
...
/**
* Helper method to set apiKey for the first OAuth2 authentication.
*
* @param apiKey Access token
*/
public void setoAuthApiKey(String apiKey) {
    for (Authentication auth : authentications.values()) {
        if (auth instanceof OAuth) {
            ((OAuth)auth).setApiKey(apiKey);
            return;
        }
    }
        throw new RuntimeException("No OAuth2 authentication configured!");
...
* Helper method to set access token for the first OAuth2 authentication.
*
* @param apiKey apiKey recieved from Precisely portal.
* @param secret secret recieved from Precisely portal.
*/
public void generateAndSetAccessToken(String apiKey, String secret)throws ApiException {
    for (Authentication auth : authentications.values()) {
        if (auth instanceof OAuth) {
        ((OAuth)auth).generateAndSetAccessToken(apiKey, secret);
        return;
        }
    }
