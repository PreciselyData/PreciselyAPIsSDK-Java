...
public class AddressAutocompleteEnterpriseServiceApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AddressAutocompleteEnterpriseServiceApi() {
        this(Configuration.getDefaultApiClient());
    }

    public AddressAutocompleteEnterpriseServiceApi(ApiClient apiClient) {
     ...
     */
    public okhttp3.Call listLocationsCall(String searchText, String transactionId, String latitude, String longitude, String searchRadius, String searchRadiusUnit, String maxCandidates, String country, String matchOnAddressNumber, String autoDetectLocation, String ipAddress, String areaName1, String areaName3, String postCode, String returnAdminAreasOnly, String includeRangesDetails, String searchType, String searchOnAddressNumber, String searchOnUnitInfo, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/typeahead/v1/list/locations";
    ...
    private okhttp3.Call listLocationsValidateBeforeCall(String searchText, String transactionId, String latitude, String longitude, String searchRadius, String searchRadiusUnit, String maxCandidates, String country, String matchOnAddressNumber, String autoDetectLocation, String ipAddress, String areaName1, String areaName3, String postCode, String returnAdminAreasOnly, String includeRangesDetails, String searchType, String searchOnAddressNumber, String searchOnUnitInfo, final ApiCallback _callback) throws ApiException {
        ...
        if (searchText == null) {
            throw new ApiException("Missing the required parameter 'searchText' when calling listLocations(Async)");
        }
        
        // verify the required parameter 'transactionId' is set
        if (transactionId == null) {
            throw new ApiException("Missing the required parameter 'transactionId' when calling listLocations(Async)");
        }
        

        okhttp3.Call localVarCall = listLocationsCall(searchText, transactionId, latitude, longitude, searchRadius, searchRadiusUnit, maxCandidates, country, matchOnAddressNumber, autoDetectLocation, ipAddress, areaName1, areaName3, postCode, returnAdminAreasOnly, includeRangesDetails, searchType, searchOnAddressNumber, searchOnUnitInfo, _callback);
        return localVarCall;
     ...
     */
    public TypeaheadLocations listLocations(String searchText, String transactionId, String latitude, String longitude, String searchRadius, String searchRadiusUnit, String maxCandidates, String country, String matchOnAddressNumber, String autoDetectLocation, String ipAddress, String areaName1, String areaName3, String postCode, String returnAdminAreasOnly, String includeRangesDetails, String searchType, String searchOnAddressNumber, String searchOnUnitInfo) throws ApiException {
        ApiResponse<TypeaheadLocations> localVarResp = listLocationsWithHttpInfo(searchText, transactionId, latitude, longitude, searchRadius, searchRadiusUnit, maxCandidates, country, matchOnAddressNumber, autoDetectLocation, ipAddress, areaName1, areaName3, postCode, returnAdminAreasOnly, includeRangesDetails, searchType, searchOnAddressNumber, searchOnUnitInfo);
     ...
     */
    public ApiResponse<TypeaheadLocations> listLocationsWithHttpInfo(String searchText, String transactionId, String latitude, String longitude, String searchRadius, String searchRadiusUnit, String maxCandidates, String country, String matchOnAddressNumber, String autoDetectLocation, String ipAddress, String areaName1, String areaName3, String postCode, String returnAdminAreasOnly, String includeRangesDetails, String searchType, String searchOnAddressNumber, String searchOnUnitInfo) throws ApiException {
        okhttp3.Call localVarCall = listLocationsValidateBeforeCall(searchText, transactionId, latitude, longitude, searchRadius, searchRadiusUnit, maxCandidates, country, matchOnAddressNumber, autoDetectLocation, ipAddress, areaName1, areaName3, postCode, returnAdminAreasOnly, includeRangesDetails, searchType, searchOnAddressNumber, searchOnUnitInfo, null);
     ...
     */
    public okhttp3.Call listLocationsAsync(String searchText, String transactionId, String latitude, String longitude, String searchRadius, String searchRadiusUnit, String maxCandidates, String country, String matchOnAddressNumber, String autoDetectLocation, String ipAddress, String areaName1, String areaName3, String postCode, String returnAdminAreasOnly, String includeRangesDetails, String searchType, String searchOnAddressNumber, String searchOnUnitInfo, final ApiCallback<TypeaheadLocations> _callback) throws ApiException {
    ...
    /**
     * Build call for listSelect
     * @param selectedAddress Selected Address to be searched. (required)
     * @param transactionId transactionId. (required)
     * @param country Country ISO code. We need to make sure that either Lat/Lng or Country is provided to API (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call listSelectCall(String selectedAddress, String transactionId, String country, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/typeahead/v1/list/select";
        ...
        if (selectedAddress != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("selectedAddress", selectedAddress));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listSelectValidateBeforeCall(String selectedAddress, String transactionId, String country, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'selectedAddress' is set
        if (selectedAddress == null) {
            throw new ApiException("Missing the required parameter 'selectedAddress' when calling listSelect(Async)");
        }
        
        // verify the required parameter 'transactionId' is set
        if (transactionId == null) {
            throw new ApiException("Missing the required parameter 'transactionId' when calling listSelect(Async)");
        }
        

        okhttp3.Call localVarCall = listSelectCall(selectedAddress, transactionId, country, _callback);
        return localVarCall;
     ...
     */
    public Object listSelect(String selectedAddress, String transactionId, String country) throws ApiException {
        ApiResponse<Object> localVarResp = listSelectWithHttpInfo(selectedAddress, transactionId, country);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> listSelectWithHttpInfo(String selectedAddress, String transactionId, String country) throws ApiException {
        okhttp3.Call localVarCall = listSelectValidateBeforeCall(selectedAddress, transactionId, country, null);
     ...
     */
    public okhttp3.Call listSelectAsync(String selectedAddress, String transactionId, String country, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = listSelectValidateBeforeCall(selectedAddress, transactionId, country, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
