...
public class GeocodeServiceApi {
    ...
    private com.squareup.okhttp.Call geocodeCall(String datapackBundle, String country, String placeName, String mainAddress, String lastLine, String areaName1, String areaName2, String areaName3, String areaName4, Integer postalCode, String matchMode, Boolean fallbackGeo, Boolean fallbackPostal, Integer maxCands, Integer streetOffset, String streetOffsetUnits, Integer cornerOffset, String cornerOffsetUnits, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/geocode/v1/{datapackBundle}/geocode".replaceAll("\\{format\\}","json")
    ...
    /**
     * Get Forward Geocode (asynchronously)
     * This service accepts an address and returns the location coordinates corresponding to that address. Premium offers the best accuracy and is a high precision geocoder leveraging Master Location Data - geocodes to Street or building level.
     * @param datapackBundle value of datapackBundle (required)
     * @param country Country name or ISO code. (optional, default to USA)
     * @param placeName Building name, place name, Point of Interest (POI), company or firm name associated with the input address. (optional)
    ...
    private com.squareup.okhttp.Call geocodeBatchCall(GeocodeRequest body, String datapackBundle, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling geocodeBatch(Async)");
        }
     ...
     * @param body Geocode Request Object (required)
     * @param datapackBundle value of datapackBundle (required)
     * @return GeocodeServiceResponseList
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GeocodeServiceResponseList geocodeBatch(GeocodeRequest body, String datapackBundle) throws ApiException {
        ApiResponse<GeocodeServiceResponseList> resp = geocodeBatchWithHttpInfo(body, datapackBundle);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GeocodeServiceResponseList> geocodeBatchWithHttpInfo(GeocodeRequest body, String datapackBundle) throws ApiException {
        com.squareup.okhttp.Call call = geocodeBatchCall(body, datapackBundle, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call geocodeBatchAsync(GeocodeRequest body, String datapackBundle, final ApiCallback<GeocodeServiceResponseList> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = geocodeBatchCall(body, datapackBundle, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GeocodeServiceResponseList>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    private com.squareup.okhttp.Call getCapabilitiesCall(String datapackBundle, String operation, String country, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/geocode/v1/{datapackBundle}/capabilities".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "datapackBundle" + "\\}", apiClient.escapeString(datapackBundle.toString()));
    ...
    /**
     * Get Capabilities (asynchronously)
     * Get Capabilities  of Geocode API
     * @param datapackBundle value of datapackBundle (required)
     * @param operation Geocode or ReverseGeocode Operation. (optional, default to geocode)
     * @param country Country name or ISO code. (optional, default to USA)
    ...
    private com.squareup.okhttp.Call getDictionariesCall(String datapackBundle, String country, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/geocode/v1/{datapackBundle}/dictionaries".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "datapackBundle" + "\\}", apiClient.escapeString(datapackBundle.toString()));
    ...
    /**
     * Get installed Dictionaries (asynchronously)
     * Get installed Dictionaries
     * @param datapackBundle value of datapackBundle (required)
     * @param country Three Letter ISO Country code (optional, default to USA)
     * @param callback The callback to be executed when the API call finishes
    ...
    /* Build call for getPreciselyID */
    private com.squareup.okhttp.Call getPreciselyIDCall(String address, String country, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'address' is set
        if (address == null) {
            throw new ApiException("Missing the required parameter 'address' when calling getPreciselyID(Async)");
        }
        

        // create path and map variables
        String localVarPath = "/geocode/v1/key/byaddress".replaceAll("\\{format\\}","json");
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PBKeyResponse getPreciselyID(String address, String country) throws ApiException {
        ApiResponse<PBKeyResponse> resp = getPreciselyIDWithHttpInfo(address, country);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PBKeyResponse> getPreciselyIDWithHttpInfo(String address, String country) throws ApiException {
        com.squareup.okhttp.Call call = getPreciselyIDCall(address, country, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPreciselyIDAsync(String address, String country, final ApiCallback<PBKeyResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPreciselyIDCall(address, country, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PBKeyResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for getPreciselyIDs */
    private com.squareup.okhttp.Call getPreciselyIDsCall(PBKeyAddressRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling getPreciselyIDs(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PBKeyResponseList getPreciselyIDs(PBKeyAddressRequest body) throws ApiException {
        ApiResponse<PBKeyResponseList> resp = getPreciselyIDsWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PBKeyResponseList> getPreciselyIDsWithHttpInfo(PBKeyAddressRequest body) throws ApiException {
        com.squareup.okhttp.Call call = getPreciselyIDsCall(body, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPreciselyIDsAsync(PBKeyAddressRequest body, final ApiCallback<PBKeyResponseList> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPreciselyIDsCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PBKeyResponseList>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for keyLookup */
    private com.squareup.okhttp.Call keyLookupCall(String key, String type, String country, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/geocode/v1/keylookup".replaceAll("\\{format\\}","json");
     ...
     * @param key free form text (required)
     * @param type  (optional)
    ...
    public GeocodeServiceResponse keyLookup(String key, String type, String country) throws ApiException {
        ApiResponse<GeocodeServiceResponse> resp = keyLookupWithHttpInfo(key, type, country);
        return resp.getData();
    }
    ...
    public ApiResponse<GeocodeServiceResponse> keyLookupWithHttpInfo(String key, String type, String country) throws ApiException {
        com.squareup.okhttp.Call call = keyLookupCall(key, type, country, null, null);
        Type localVarReturnType = new TypeToken<GeocodeServiceResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call keyLookupAsync(String key, String type, String country, final ApiCallback<GeocodeServiceResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = keyLookupCall(key, type, country, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GeocodeServiceResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for keyLookupBatch */
    private com.squareup.okhttp.Call keyLookupBatchCall(KeyLookupRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GeocodeServiceResponseList keyLookupBatch(KeyLookupRequest body) throws ApiException {
        ApiResponse<GeocodeServiceResponseList> resp = keyLookupBatchWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GeocodeServiceResponseList> keyLookupBatchWithHttpInfo(KeyLookupRequest body) throws ApiException {
        com.squareup.okhttp.Call call = keyLookupBatchCall(body, null, null);
        Type localVarReturnType = new TypeToken<GeocodeServiceResponseList>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call keyLookupBatchAsync(KeyLookupRequest body, final ApiCallback<GeocodeServiceResponseList> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = keyLookupBatchCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GeocodeServiceResponseList>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    private com.squareup.okhttp.Call reverseGeocodBatchCall(String datapackBundle, ReverseGeocodeRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/geocode/v1/{datapackBundle}/reverseGeocode".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "datapackBundle" + "\\}", apiClient.escapeString(datapackBundle.toString()));
    ...
    /**
     * Get Reverse Geocode (asynchronously)
     * This service accepts location coordinate and returns an address.
     * @param datapackBundle value of datapackBundle (required)
     * @param x Longitude of the location. (required)
     * @param y Latitude of the location. (required)
