...
import com.precisely.apis.model.TimezoneLocationResponse;
import com.precisely.apis.model.Timezone;
...
public class TimeZoneServiceApi {
    ...
    private com.squareup.okhttp.Call getBatchTimezoneByAddressCall(TimezoneAddressRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/timezone/v1/timezone/byaddress".replaceAll("\\{format\\}","json");
    ...
    private com.squareup.okhttp.Call getBatchTimezoneByLocationCall(TimezoneLocationRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/timezone/v1/timezone/bylocation".replaceAll("\\{format\\}","json");
