...
public class RisksServiceApi {
    ...
    /**
     * Build call for getFireHistoryV2
     * @param postCode 5 digit Postal code to search (required)
     * @param startDate Start time in milliseconds(UTC) (optional)
     * @param endDate End time in milliseconds(UTC) (optional)
     * @param maxCandidates Maximum response events (optional)
     ...
     */
    public okhttp3.Call getFireHistoryV2Call(String postCode, String startDate, String endDate, String maxCandidates, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/risks/v2/firehistory";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getFireHistoryV2ValidateBeforeCall(String postCode, String startDate, String endDate, String maxCandidates, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'postCode' is set
        if (postCode == null) {
            throw new ApiException("Missing the required parameter 'postCode' when calling getFireHistoryV2(Async)");
        }
        

        okhttp3.Call localVarCall = getFireHistoryV2Call(postCode, startDate, endDate, maxCandidates, _callback);
        return localVarCall;
     ...
     */
    public FireHistoryV2 getFireHistoryV2(String postCode, String startDate, String endDate, String maxCandidates) throws ApiException {
        ApiResponse<FireHistoryV2> localVarResp = getFireHistoryV2WithHttpInfo(postCode, startDate, endDate, maxCandidates);
        return localVarResp.getData();
    }
     ...
     * @param endDate End time in milliseconds(UTC) (optional)
     * @param maxCandidates Maximum response events (optional)
     * @return ApiResponse&lt;FireHistoryV2&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<FireHistoryV2> getFireHistoryV2WithHttpInfo(String postCode, String startDate, String endDate, String maxCandidates) throws ApiException {
        okhttp3.Call localVarCall = getFireHistoryV2ValidateBeforeCall(postCode, startDate, endDate, maxCandidates, null);
        Type localVarReturnType = new TypeToken<FireHistoryV2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getFireHistoryV2Async(String postCode, String startDate, String endDate, String maxCandidates, final ApiCallback<FireHistoryV2> _callback) throws ApiException {

        okhttp3.Call localVarCall = getFireHistoryV2ValidateBeforeCall(postCode, startDate, endDate, maxCandidates, _callback);
        Type localVarReturnType = new TypeToken<FireHistoryV2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for getFireRiskV2ByAddress
     * @param address Free form address text (required)
     * @param includeGeometry Flag to return Geometry default is N (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call getFireRiskV2ByAddressCall(String address, String includeGeometry, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/risks/v2/fire/byaddress";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getFireRiskV2ByAddressValidateBeforeCall(String address, String includeGeometry, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'address' is set
        if (address == null) {
            throw new ApiException("Missing the required parameter 'address' when calling getFireRiskV2ByAddress(Async)");
        }
        

        okhttp3.Call localVarCall = getFireRiskV2ByAddressCall(address, includeGeometry, _callback);
        return localVarCall;
     ...
     */
    public FireRiskV2Response getFireRiskV2ByAddress(String address, String includeGeometry) throws ApiException {
        ApiResponse<FireRiskV2Response> localVarResp = getFireRiskV2ByAddressWithHttpInfo(address, includeGeometry);
        return localVarResp.getData();
    }
     ...
     * @param address Free form address text (required)
     * @param includeGeometry Flag to return Geometry default is N (optional)
     * @return ApiResponse&lt;FireRiskV2Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<FireRiskV2Response> getFireRiskV2ByAddressWithHttpInfo(String address, String includeGeometry) throws ApiException {
        okhttp3.Call localVarCall = getFireRiskV2ByAddressValidateBeforeCall(address, includeGeometry, null);
        Type localVarReturnType = new TypeToken<FireRiskV2Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getFireRiskV2ByAddressAsync(String address, String includeGeometry, final ApiCallback<FireRiskV2Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getFireRiskV2ByAddressValidateBeforeCall(address, includeGeometry, _callback);
        Type localVarReturnType = new TypeToken<FireRiskV2Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getFireRiskV2ByAddressBatch
     * @param fireRiskByAddressRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getFireRiskV2ByAddressBatchCall(FireRiskByAddressRequest fireRiskByAddressRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getFireRiskV2ByAddressBatchValidateBeforeCall(FireRiskByAddressRequest fireRiskByAddressRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'fireRiskByAddressRequest' is set
        if (fireRiskByAddressRequest == null) {
            throw new ApiException("Missing the required parameter 'fireRiskByAddressRequest' when calling getFireRiskV2ByAddressBatch(Async)");
        }
        

        okhttp3.Call localVarCall = getFireRiskV2ByAddressBatchCall(fireRiskByAddressRequest, _callback);
        return localVarCall;
     ...
     */
    public FireRiskV2ResponseList getFireRiskV2ByAddressBatch(FireRiskByAddressRequest fireRiskByAddressRequest) throws ApiException {
        ApiResponse<FireRiskV2ResponseList> localVarResp = getFireRiskV2ByAddressBatchWithHttpInfo(fireRiskByAddressRequest);
        return localVarResp.getData();
    }
     ...
     * This is a Batch offering for &#39;Fire Risk By Address&#39; service. It accepts a single address or a list of addresses and retrieve fire risk data by risk types.
     * @param fireRiskByAddressRequest  (required)
     * @return ApiResponse&lt;FireRiskV2ResponseList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<FireRiskV2ResponseList> getFireRiskV2ByAddressBatchWithHttpInfo(FireRiskByAddressRequest fireRiskByAddressRequest) throws ApiException {
        okhttp3.Call localVarCall = getFireRiskV2ByAddressBatchValidateBeforeCall(fireRiskByAddressRequest, null);
        Type localVarReturnType = new TypeToken<FireRiskV2ResponseList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getFireRiskV2ByAddressBatchAsync(FireRiskByAddressRequest fireRiskByAddressRequest, final ApiCallback<FireRiskV2ResponseList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getFireRiskV2ByAddressBatchValidateBeforeCall(fireRiskByAddressRequest, _callback);
        Type localVarReturnType = new TypeToken<FireRiskV2ResponseList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getFireRiskV2ByLocation
     * @param longitude Longitude of Location (required)
     * @param latitude Latitude of Location (required)
     * @param includeGeometry Flag to return Geometry default is N (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call getFireRiskV2ByLocationCall(String longitude, String latitude, String includeGeometry, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/risks/v2/fire/bylocation";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getFireRiskV2ByLocationValidateBeforeCall(String longitude, String latitude, String includeGeometry, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'longitude' is set
        if (longitude == null) {
            throw new ApiException("Missing the required parameter 'longitude' when calling getFireRiskV2ByLocation(Async)");
        }
        
        // verify the required parameter 'latitude' is set
        if (latitude == null) {
            throw new ApiException("Missing the required parameter 'latitude' when calling getFireRiskV2ByLocation(Async)");
        }
        

        okhttp3.Call localVarCall = getFireRiskV2ByLocationCall(longitude, latitude, includeGeometry, _callback);
        return localVarCall;
     ...
     */
    public FireRiskV2Response getFireRiskV2ByLocation(String longitude, String latitude, String includeGeometry) throws ApiException {
        ApiResponse<FireRiskV2Response> localVarResp = getFireRiskV2ByLocationWithHttpInfo(longitude, latitude, includeGeometry);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<FireRiskV2Response> getFireRiskV2ByLocationWithHttpInfo(String longitude, String latitude, String includeGeometry) throws ApiException {
        okhttp3.Call localVarCall = getFireRiskV2ByLocationValidateBeforeCall(longitude, latitude, includeGeometry, null);
        Type localVarReturnType = new TypeToken<FireRiskV2Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getFireRiskV2ByLocationAsync(String longitude, String latitude, String includeGeometry, final ApiCallback<FireRiskV2Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getFireRiskV2ByLocationValidateBeforeCall(longitude, latitude, includeGeometry, _callback);
        Type localVarReturnType = new TypeToken<FireRiskV2Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getFireRiskV2ByLocationBatch
     * @param fireRiskByLocationRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getFireRiskV2ByLocationBatchCall(FireRiskByLocationRequest fireRiskByLocationRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getFireRiskV2ByLocationBatchValidateBeforeCall(FireRiskByLocationRequest fireRiskByLocationRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'fireRiskByLocationRequest' is set
        if (fireRiskByLocationRequest == null) {
            throw new ApiException("Missing the required parameter 'fireRiskByLocationRequest' when calling getFireRiskV2ByLocationBatch(Async)");
        }
        

        okhttp3.Call localVarCall = getFireRiskV2ByLocationBatchCall(fireRiskByLocationRequest, _callback);
        return localVarCall;
     ...
     */
    public FireRiskV2ResponseList getFireRiskV2ByLocationBatch(FireRiskByLocationRequest fireRiskByLocationRequest) throws ApiException {
        ApiResponse<FireRiskV2ResponseList> localVarResp = getFireRiskV2ByLocationBatchWithHttpInfo(fireRiskByLocationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<FireRiskV2ResponseList> getFireRiskV2ByLocationBatchWithHttpInfo(FireRiskByLocationRequest fireRiskByLocationRequest) throws ApiException {
        okhttp3.Call localVarCall = getFireRiskV2ByLocationBatchValidateBeforeCall(fireRiskByLocationRequest, null);
        Type localVarReturnType = new TypeToken<FireRiskV2ResponseList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getFireRiskV2ByLocationBatchAsync(FireRiskByLocationRequest fireRiskByLocationRequest, final ApiCallback<FireRiskV2ResponseList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getFireRiskV2ByLocationBatchValidateBeforeCall(fireRiskByLocationRequest, _callback);
        Type localVarReturnType = new TypeToken<FireRiskV2ResponseList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
