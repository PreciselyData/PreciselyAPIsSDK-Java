...
public class PropertyInformationServiceApi {
    ...
    private com.squareup.okhttp.Call getPropertyAttributesByAddressCall(String address, String attributes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public PropertyInfoResponse getPropertyAttributesByAddress(String address, String attributes) throws ApiException {
        ApiResponse<PropertyInfoResponse> resp = getPropertyAttributesByAddressWithHttpInfo(address, attributes);
        return resp.getData();
    }
    ...
    public ApiResponse<PropertyInfoResponse> getPropertyAttributesByAddressWithHttpInfo(String address, String attributes) throws ApiException {
        com.squareup.okhttp.Call call = getPropertyAttributesByAddressCall(address, attributes, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPropertyAttributesByAddressAsync(String address, String attributes, final ApiCallback<PropertyInfoResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPropertyAttributesByAddressCall(address, attributes, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PropertyInfoResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
