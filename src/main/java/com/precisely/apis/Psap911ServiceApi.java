...
public class Psap911ServiceApi {
    ...
    /**
     * Build call for searchByFccId
     * @param fccId fccId (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call searchByFccIdCall(String fccId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/911/v1/ahj-psap/byfccid";
        ...
        if (fccId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("fccId", fccId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchByFccIdValidateBeforeCall(String fccId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'fccId' is set
        if (fccId == null) {
            throw new ApiException("Missing the required parameter 'fccId' when calling searchByFccId(Async)");
        }
        

        okhttp3.Call localVarCall = searchByFccIdCall(fccId, _callback);
        return localVarCall;
     ...
     */
    public AHJPlusPSAPResponse searchByFccId(String fccId) throws ApiException {
        ApiResponse<AHJPlusPSAPResponse> localVarResp = searchByFccIdWithHttpInfo(fccId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AHJPlusPSAPResponse> searchByFccIdWithHttpInfo(String fccId) throws ApiException {
        okhttp3.Call localVarCall = searchByFccIdValidateBeforeCall(fccId, null);
        Type localVarReturnType = new TypeToken<AHJPlusPSAPResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * AHJ &amp; PSAP By Fccid (asynchronously)
     * Accepts fccid as input and Returns contact details for Authorities Having Jurisdiction (AHJ) on-behalf-of local Public Safety Answering Points (PSAP). 911/PSAP accepts a location coordinate and returns PSAP contact data plus contact data for an AHJ to communicate directly with a PSAP. Details include agency name, phone number, city name, coverage, contact person&#39;s details, site details and mailing addresses for EMS, Fire, and Police PSAP contacts.
     * @param fccId fccId (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call searchByFccIdAsync(String fccId, final ApiCallback<AHJPlusPSAPResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchByFccIdValidateBeforeCall(fccId, _callback);
        Type localVarReturnType = new TypeToken<AHJPlusPSAPResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
