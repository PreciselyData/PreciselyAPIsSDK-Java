...
public class HealthTheme   {
  ...
  **/
  ...
  public HealthTheme individualValueVariable(List<IndividualValueVariableV2> individualValueVariable) {
  ...
  **/
  ...
  public HealthTheme rangeVariable(List<RangeVariableV2> rangeVariable) {
