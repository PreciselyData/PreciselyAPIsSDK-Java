...
public class EmploymentTheme   {
  ...
  **/
  ...
  public EmploymentTheme individualValueVariable(List<IndividualValueVariableV2> individualValueVariable) {
  ...
  **/
  ...
  public EmploymentTheme rangeVariable(List<RangeVariableV2> rangeVariable) {
