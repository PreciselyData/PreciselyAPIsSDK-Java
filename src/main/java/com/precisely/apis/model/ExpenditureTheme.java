...
public class ExpenditureTheme   {
  ...
  **/
  ...
  public ExpenditureTheme individualValueVariable(List<IndividualValueVariableV2> individualValueVariable) {
  ...
  **/
  ...
  public ExpenditureTheme rangeVariable(List<RangeVariableV2> rangeVariable) {
