...
public class HouseholdsTheme   {
  ...
  **/
  ...
  public HouseholdsTheme individualValueVariable(List<IndividualValueVariableV2> individualValueVariable) {
  ...
  **/
  ...
  public HouseholdsTheme rangeVariable(List<RangeVariableV2> rangeVariable) {
