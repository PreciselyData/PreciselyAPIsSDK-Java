...
public class ValidateMailingAddressPremiumOptions {
  ...
  public ValidateMailingAddressPremiumOptions() { 
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the type of output record you get.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies whether to include field-level result indicators.")
